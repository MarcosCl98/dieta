...
export const DIET_DATA: Record<DayType, Record<string, DayData>> = {
  ...
  cardio: {
    tarde: {
      macros: { kcal: 2080, prot: 150, carbs: 188, grasa: 68 },
      timeline: [
        { time: '8:00', label: 'Desayuno', type: 'i' },
        { time: '13:00', label: 'Comida\npre-cardio', type: 'ac' },
        { time: '15:00', label: 'CARDIO', type: 'wn' },
        { time: '17:00', label: 'Post-cardio', type: 'i' },
        { time: '21:00', label: 'Cena', type: 'i' },
      ],
      meals: [
        {
          ...
          prot: 36,
          noteType: '',
          note: 'Carbos algo reducidos. Proteína igual de alta.',
          options: [
            { id: 'a', name: '60g avena + 200ml leche prot desnatada + 120ml claras + 1 huevo + 1 fruta', kcal: 510, prot: 42, carbs: 54, grasa: 12, type: 'normal' },
            { id: 'b', name: '2 tostadas Oroweat + 120ml claras + 1 huevo + 60g pechuga de pavo loncheada', kcal: 490, prot: 40, carbs: 44, grasa: 12, type: 'rapida', recipe: R.tort },
            { id: 'c', name: 'Bol: yogur straciatella (120g) + 200ml leche prot desnatada + 60g avena + arándanos (80g)', kcal: 450, prot: 28, carbs: 64, grasa: 6, type: 'yogur' },
            { id: 'd', name: 'Bocadillo: pan blanco (70g) + 60g jamón serrano + café leche prot desnatada', kcal: 450, prot: 34, carbs: 46, grasa: 16, type: 'rapida', recipe: R.boca },
            { id: 'e', name: 'Batido: 30g whey + 200ml leche prot desnatada + 60g avena + 1 fruta', kcal: 520, prot: 46, carbs: 56, grasa: 8, type: 'normal' },
          ],
        },
        {
          id: 'comida',
          title: 'Comida — pre-cardio',
          time: '13:00h (2h antes)',
          kcal: 650,
          prot: 46,
          tag: 'pre-cardio',
          noteType: 'g',
          note: 'Carbos moderados. El cuerpo usa grasa como combustible durante el cardio.',
          options: [
            { id: 'a', name: `150g pollo (air fryer) + 60g arroz + ${veg('verduras')} + 10ml AOVE + yogur straciatella (120g)`, kcal: 630, prot: 46, carbs: 56, grasa: 12, type: 'airfryer', recipe: R.afc, comp: '+ yogur straciatella compensa los 50g menos de pollo' },
            { id: 'b', name: `200g merluza (air fryer) + 150g patata + ${veg('ensalada')} + 10ml AOVE`, kcal: 620, prot: 44, carbs: 52, grasa: 12, type: 'airfryer', recipe: R.afm },
            ...
            { id: 'd', name: 'Bocadillo: pan blanco (100g) + 120g pechuga de pavo loncheada + AOVE + 1 fruta', kcal: 620, prot: 40, carbs: 62, grasa: 10, type: 'rapida', recipe: R.boca },
            { id: 'e', name: `150g ternera magra/carne picada + 150g patata + ${veg('verduras')} + 10ml AOVE + yogur straciatella (120g)`, kcal: 640, prot: 46, carbs: 50, grasa: 16, type: 'normal', comp: '+ yogur straciatella compensa los 50g menos de carne' },
          ],
        },
        {
          id: 'post',
          ...
          prot: 24,
          noteType: 'a',
          note: 'Solo proteína o casi. No frenamos el efecto oxidativo del cardio.',
          options: [
            { id: 'a', name: '30g whey + agua', kcal: 120, prot: 26, carbs: 3, grasa: 2, type: 'normal' },
            { id: 'b', name: '30g whey + agua + 1 mandarina o kiwi', kcal: 185, prot: 26, carbs: 16, grasa: 2, type: 'normal' },
            { id: 'c', name: 'Yogur straciatella (120g) + 200ml leche prot desnatada', kcal: 180, prot: 22, carbs: 14, grasa: 4, type: 'yogur' },
            { id: 'd', name: '200g Skyr natural 0% solo', kcal: 130, prot: 20, carbs: 8, grasa: 0, type: 'yogur' },
            { id: 'e', name: '120ml claras + 1 huevo revuelto (sin pan)', kcal: 130, prot: 18, carbs: 1, grasa: 6, type: 'normal', recipe: R.tort },
          ],
        },
        {
          id: 'cena',
          ...
          prot: 44,
          noteType: '',
          note: 'Sin carbos almidonados. Proteína + grasas + verdura.',
          options: [
            { id: 'a', name: `200g salmón (air fryer) + ${veg('ensalada')} + 15ml AOVE`, kcal: 510, prot: 42, carbs: 8, grasa: 32, type: 'airfryer', recipe: R.afs },
            { id: 'b', name: `150g pollo (air fryer) + ${veg('brócoli')} + 2 huevos plancha + 10ml AOVE + yogur straciatella (120g)`, kcal: 510, prot: 46, carbs: 10, grasa: 20, type: 'airfryer', recipe: R.afc, comp: '+ yogur straciatella compensa los 50g menos de pollo' },
            ...
            { id: 'e', name: 'Hamburguesa ibérica: 150g cerdo ibérico picado + 2 lonchas queso + pan brioche', kcal: 680, prot: 40, carbs: 40, grasa: 36, type: 'ocasional', recipe: R.afh },
          ],
        },
      ],
    },
    manana: {
      macros: { kcal: 2080, prot: 150, carbs: 188, grasa: 68 },
      timeline: [
        { time: '7:00', label: 'Pre-cardio\nopcional', type: 'ac' },
        { time: '7:30', label: 'CARDIO', type: 'wn' },
        { time: '9:30', label: 'Post-cardio\n(desayuno)', type: 'i' },
        { time: '14:00', label: 'Comida', type: 'i' },
        { time: '21:00', label: 'Cena', type: 'i' },
      ],
      meals: [
        {
          id: 'pre',
          title: 'Pre-cardio — opcional',
          time: '7:00h',
          kcal: 30,
          prot: 1,
          tag: 'pre-cardio',
          noteType: 'a',
          note: 'Cardio en ayunas ideal para quemar grasa.',
          options: [
            { id: 'a', name: 'Nada — cardio en ayunas (recomendado)', kcal: 0, prot: 0, carbs: 0, grasa: 0, type: 'normal' },
            { id: 'b', name: 'Café solo + agua', kcal: 5, prot: 0, carbs: 0, grasa: 0, type: 'normal' },
            { id: 'c', name: '1 mandarina pequeña + café', kcal: 40, prot: 0, carbs: 10, grasa: 0, type: 'normal' },
          ],
        },
        {
          id: 'post',
          title: 'Post-cardio — desayuno',
          time: '9:30h',
          kcal: 510,
          prot: 38,
          tag: 'post-cardio',
          noteType: 'i',
          note: 'Carbos moderados. Proteína alta.',
          options: [
            { id: 'a', name: '60g avena + 200ml leche prot desnatada + 120ml claras + 1 huevo + 1 fruta', kcal: 510, prot: 42, carbs: 54, grasa: 12, type: 'normal' },
            { id: 'b', name: '200g Skyr natural + 60g avena + 1 plátano pequeño + café', kcal: 500, prot: 38, carbs: 60, grasa: 6, type: 'yogur' },
            { id: 'c', name: 'Bol: yogur straciatella (120g) + 200ml leche prot desnatada + 60g avena + arándanos (80g)', kcal: 450, prot: 28, carbs: 64, grasa: 6, type: 'yogur' },
            { id: 'd', name: 'Bocadillo: pan blanco (80g) + 120ml claras + 1 huevo + 60g pechuga de pavo loncheada + 1 fruta', kcal: 520, prot: 42, carbs: 48, grasa: 14, type: 'rapida' },
            { id: 'e', name: '30g whey + 200ml leche prot desnatada + 60g avena + 1 fruta', kcal: 540, prot: 50, carbs: 56, grasa: 8, type: 'normal' },
          ],
        },
        {
          id: 'comida',
          ...
          note: 'Carbos moderados. Proteína alta.',
          options: [
            { id: 'a', name: `150g pollo (air fryer) + 60g arroz + ${veg('verduras')} + 10ml AOVE + yogur straciatella (120g)`, kcal: 630, prot: 46, carbs: 54, grasa: 12, type: 'airfryer', recipe: R.afc, comp: '+ yogur straciatella compensa los 50g menos de pollo' },
            { id: 'b', name: `200g salmón (air fryer) + 150g boniato + ${veg('espárragos')} + 10ml AOVE`, kcal: 680, prot: 44, carbs: 50, grasa: 26, type: 'airfryer', recipe: R.afs },
            { id: 'c', name: `150g pollo (air fryer) + 150g gnocchi salteados + salsa tomate + 10ml AOVE + 1 huevo duro`, kcal: 650, prot: 48, carbs: 56, grasa: 14, type: 'airfryer', recipe: R.gnoc, comp: '+ huevo duro compensa los 50g menos de pollo' },
            { id: 'd', name: 'Bocadillo: pan blanco (100g) + 80g jamón serrano + AOVE + 1 fruta', kcal: 640, prot: 40, carbs: 62, grasa: 16, type: 'rapida', recipe: R.boca },
            { id: 'e', name: `200g merluza (air fryer) + 150g patata + ${veg('ensalada')} + 10ml AOVE`, kcal: 620, prot: 44, carbs: 52, grasa: 12, type: 'airfryer', recipe: R.afm },
          ],
        },
        {
          id: 'cena',
